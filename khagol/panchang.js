...
const tithiNames = ["प्रतिपदा, शुक्ल पक्ष", "द्वितीया, शुक्ल पक्ष", "तृतीया, शुक्ल पक्ष", "चतुर्थी, शुक्ल पक्ष", "पञ्चमी, शुक्ल पक्ष", "षष्ठी, शुक्ल पक्ष", "सप्तमी, शुक्ल पक्ष", "अष्टमी, शुक्ल पक्ष", "नवमी, शुक्ल पक्ष", "दशमी, शुक्ल पक्ष", "एकादशी, शुक्ल पक्ष", "द्वादशी, शुक्ल पक्ष", "त्रयोदशी, शुक्ल पक्ष", "चतुर्दशी, शुक्ल पक्ष", "पूर्णिमा, शुक्ल पक्ष",
    "प्रतिपदा, कृष्ण पक्ष", "द्वितीया, कृष्ण पक्ष", "तृतीया, कृष्ण पक्ष", "चतुर्थी, कृष्ण पक्ष", "पञ्चमी, कृष्ण पक्ष", "षष्ठी, कृष्ण पक्ष", "सप्तमी, कृष्ण पक्ष", "अष्टमी, कृष्ण पक्ष", "नवमी, कृष्ण पक्ष", "दशमी, कृष्ण पक्ष", "एकादशी, कृष्ण पक्ष", "द्वादशी, कृष्ण पक्ष", "त्रयोदशी, कृष्ण पक्ष", "चतुर्दशी, शुक्ल पक्ष", "अमावस्या"];
    
const padaNames = ["चु", "चे", "चो", "ला", "ली", "लू", "ले", "लो", "अ", "ई", "उ", "ए ", "ओ", "वा", "वी", "वु", "वे", "वो", "का", "की", "कु", "घ", "ङ", "छ", "के", "को", "हा", "ही ", "हु", "हे", "हो", "ड ", "डी", "डू", "डे", "डो", "मा", "मी", "मू", "मे", "मो ", 
"टा", "टी", "टू", "टे", "टो", "पा", "पी", "पू", "ष", "ण", "ठ", "पे", "पो", "रा", "री", "रू", "रे", "रो", "ता", "ती", "तू", "ते", "तो", "ना", "नी", "नू", "ने", "नो", "या", "यी", "यू", "ये", "यो", "भा", "भी", "भू", "धा", "फा", "ढा", "भे", "भो", "जा", "जी", "खी", 
"खू", "खे", "खो", "गा", "गी", "गु", "गे", "गो", "सा", "सी", "सू", "से", "सो", "दा", "दी", "दू", "थ", "झ", "ञ", "दे", "दो", "च", "ची"];
...
var yogaNames=["विश्कुम्भ","प्रीति","आयुष्मान","सौभाग्य","शोभन","अतिगंड","सुकर्मा","धृति","शूल","गण्ड","वृद्वि","ध्रुव","व्याघात","हर्शण","वज्र","सिद्वि","व्यतापता","वरियान","परिघ","शिव","सिद्ध","साध्य","शुभ","शुक्ल","ब्रह्म","ऐन्द्र","वैधृति"];
var daysOfWeek = ["रविवार", "सोमवार", "मंगलवार", "बुधवार", "गुरुवार", "शुक्रवार", "शनिवार"];
var karan_list = ["किन्स्तुघ्न","बव","बालव","कौलव","तैतुल","गर","वणिज","विष्टि भद्र","शकुनी","चतुष्पद","नागव"];


 /**
* Calculates and returns basic Panchang details as an HTML string.
* Uses the planet data stored from the last drawWheel call.
...
function getAyanamsa(date,sayan=false){
  ...
  //TODO Correct Julian day . mismatch of few days
    ...
    const ln = 125.0445550 - 1934.1361849 * t + 0.0020762 * t * t;
    // Calculate Mean Sun longitude
    let off = 280.466449 + 36000.7698231 * t + 0.00031060 * t * t;
    ...
    off = 17.23 * Math.sin(ln*Math.PI/180)
 ...
 * @param {Date} currentDate The date object for which to calculate the elapsed days.
 * @returns {number} The number of full days elapsed, or NaN if input is invalid.
 *                   Returns negative if currentDate is before the Kali Yuga start.
 */
...
function calculateAscendant(lst,ecliptic,location) {
    ...
    var ascendant= Math.atan2(-Math.cos(lst),Math.sin(lst)*Math.cos(ecliptic)+Math.tan(latitude)*Math.sin(ecliptic));
    //midheaven = Math.atan2(Math.tan(lst),Math.cos(ecliptic))
    if(ascendant < Math.PI)
