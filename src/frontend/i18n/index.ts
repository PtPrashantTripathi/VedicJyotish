...
const T = {
    ...
    birthDataSubtitle: {
        en: "Birth details for Kundli",
        hi: "कुंडली के लिए जन्म विवरण",
    },
    ...
    cityTip: {
        en: "Type city name in English and choose from the list.",
        hi: "अंग्रेज़ी में शहर का नाम टाइप करें और सूची से चुनें।",
    },
    cityTip2: {
        en: "If not found, pick the nearest major city.",
        hi: "नहीं मिला तो निकटतम प्रमुख शहर चुनें।",
    },
    cityTip3: {
        en: "Select city to auto-fill timezone and coordinates.",
        hi: "टाइमज़ोन और निर्देशांक स्वतः भरने के लिए शहर चुनें।",
    },
...
export function useLang() {
    ...
    const lang: LangKey =
        session.storageValues.language === "Hindi" ? "hi" : "en";
    return {
        lang,
        isHindi: lang === "hi",
