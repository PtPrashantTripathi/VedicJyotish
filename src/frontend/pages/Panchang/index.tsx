...
import {
    FaCalendarAlt, FaClock, FaExclamationTriangle, FaGlobeAsia,     FaList, FaMoon, FaStar,
FaStopwatch,
...
import { getPanchanga } from "src/backend/services/calcPanchanga";

const TAB_ICONS: Record<string, ReactNode> = {
    overview: <FaList />,
    timings: <FaClock />,
    planetary: <FaGlobeAsia />,
    muhurat: <FaStar />,
};
                    ...
                    <div className="grid gap-4 lg:grid-cols-2">
                        ...
                        <div
                            ...
                            <h3
                                ...
                                <FaStar className="h-4 w-4" /> पंचांग तत्व
                            </h3>
                        ...
                        <div className="space-y-4">
                            <div
                                ...
                                <h3
                                    ...
                                    style={{ color: "var(--c-maroon)" }}>
                                    <FaCalendarAlt className="h-4 w-4" /> कैलेंडर जानकारी
                                </h3>
                ...
                <div className="grid gap-4 lg:grid-cols-2">
                    <div
                        ...
                        <h3
                            className="mb-4 flex items-center gap-2 text-base font-bold"
                            style={{ color: "var(--c-maroon)" }}>
                            <FaSun className="h-4 w-4" /> सूर्य और चंद्र उदय / अस्त
                        </h3>
                        <div className="grid grid-cols-2 gap-3">
                            {[
                                {
                                ...
                                <div
                                    ...
                                    <span className="flex h-8 w-8 shrink-0 items-center justify-center" style={{ color: item.color }}>
                                        {item.icon}
                                    </span>
                                    <div>
                                        <p
                    ...
                    <div
                        ...
                        <h3
                            className="mb-4 flex items-center gap-2 text-base font-bold"
                            style={{ color: "var(--c-maroon)" }}>
                            <FaStopwatch className="h-4 w-4" /> दिन और रात की अवधि
                        </h3>
            ...
            {selectedTab === "planetary" && (
                <div
                    ...
                    <h3
                        className="mb-4 flex items-center gap-2 text-base font-bold"
                        style={{ color: "var(--c-maroon)" }}>
                        <FaGlobeAsia className="h-4 w-4" /> ग्रह स्थिति (Planetary Positions)
                    </h3>
            ...
            {selectedTab === "muhurat" && (
                <div
                    ...
                    <h3
                        className="mb-4 flex items-center gap-2 text-base font-bold"
                        style={{ color: "var(--c-maroon)" }}>
                        <FaStar className="h-4 w-4" /> शुभ / अशुभ मुहूर्त
                    </h3>
                    <div className="grid gap-4 md:grid-cols-2">
                        <div
                            ...
                            <p
                                ...
                                <FaStar className="h-3.5 w-3.5" /> शुभ मुहूर्त
                            </p>
                            {[
                                {
                        ...
                        <div
                            ...
                            <p className="mb-3 flex items-center gap-1.5 font-semibold text-red-700">
                                <FaExclamationTriangle className="h-3.5 w-3.5" /> अशुभ मुहूर्त
                            </p>
                            {[
                                {
                                    name: "Rahu Kalam",
