...
import { FaCog, FaExclamationTriangle,FaGlobe, FaMapMarkerAlt } from "react-icons/fa";
import { useSessionContext } from "src/frontend/contexts/SessionContext";
import {
    AyanamsaMods,
    type AyanamsaModsValue,
} from "src/backend/services/constants/AyanamsaMods";
import {
    HouseSystems,
    type HouseSystemValue,
} from "src/backend/services/constants/HouseSystems";
                    ...
                    <div className="mx-auto max-w-2xl space-y-6">
                        ...
                        <div
                            ...
                            <h3
                                ...
                                <FaMapMarkerAlt className="inline-block h-4 w-4 mr-2 align-middle" /> स्थान सेटिंग्स — Location Settings
                            </h3>
                        ...
                        <div
                            ...
                            <h3
                                className="mb-4 text-lg font-bold"
                                style={{ color: "var(--c-maroon)" }}>
                                <FaGlobe className="inline-block h-4 w-4 mr-2 align-middle" /> भाषा और प्रदर्शन — Language &amp; Display
                            </h3>
                        ...
                        <div
                            ...
                            <h3
                                className="mb-4 text-lg font-bold"
                                style={{ color: "var(--c-maroon)" }}>
                                <FaCog className="inline-block h-4 w-4 mr-2 align-middle" /> गणना सेटिंग्स — Calculation Settings
                            </h3>
                            <div className="space-y-4">
                                <div>
                                    <label
                        ...
                        <div className="text-center">
                            <button
                                ...
                                style={{
                                    ...
                                    boxShadow:
                                        "0 4px 14px rgba(212,163,115,0.35)",
                                }}>
                        ...
                        <div
                            ...
                            <p
                                ...
                                style={{ color: "#DC2626" }}>
                                <FaExclamationTriangle className="inline-block h-4 w-4 mr-2 align-middle" /> खतरा क्षेत्र — Danger Zone
                            </p>
                            <p
