...
import { FaCheckCircle,FaMapMarkerAlt, FaMapPin } from "react-icons/fa";
import FormInput from "src/frontend/components/base/FormInput";
import FormSelect from "src/frontend/components/base/FormSelect";
        ...
        <div style={{ background: "var(--c-bg)" }}>
            ...
            <form
                ...
                <FormInput
                    ...
                    onChange={e =>
                        session.updateSearchParams({ user: e.target.value })
                    }
                />
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <FormInput
                        ...
                        onChange={e =>
                            session.updateSearchParams({ date: e.target.value })
                        }
                        required
                    />
                    <FormInput
                        ...
                        onChange={e =>
                            session.updateSearchParams({ time: e.target.value })
                        }
                        required
                    />
                </div>
                ...
                <div className="relative">
                    ...
                    <div
                        className="mt-2 space-y-0.5 rounded-xl p-3 text-xs"
                        style={{
                            background: "var(--c-warm)",
                            border: "1px solid var(--c-border)",
                        }}>
                        <p style={{ color: "var(--c-text-2)" }}>
                            <FaMapMarkerAlt className="inline-block h-3 w-3 mr-1 align-middle" /> {t("cityTip")}
                        </p>
                        <p style={{ color: "var(--c-text-m)" }}>
                            <FaMapPin className="inline-block h-3 w-3 mr-1 align-middle" /> {t("cityTip2")}
                        </p>
                        <p style={{ color: "var(--c-text-m)" }}>
                            <FaCheckCircle className="inline-block h-3 w-3 mr-1 align-middle" /> {t("cityTip3")}
                        </p>
                    </div>
                </div>
                ...
                <div
                    ...
                    {showAdvanced && (
                        <div
                            className="mt-4 space-y-4 rounded-xl p-4"
                            style={{
                                background: "var(--c-warm)",
                                border: "1px solid var(--c-border)",
                            }}>
