...
import { FaChartBar, FaHourglassHalf,FaStar, FaTable } from "react-icons/fa";
import ChartInfoTable from "src/frontend/components/ChartInfoTable";
import KundliChartSVG from "src/frontend/components/KundliChartSVG";
import KundliYogPhala from "src/frontend/components/KundliYogPhala";
import VimsottariDasa from "src/frontend/components/VimsottariDasa";
import { useSessionContext } from "src/frontend/contexts/SessionContext";
import { Kundli } from "src/backend/services/Kundli";
import { DMS } from "src/backend/services/utils";
import { fmtDate, fmtTime } from "src/frontend/utils/formatDate";
...
export default function KundliResult() {
    ...
    const tabs: Record<string, { label: string; icon: ReactNode }> = {
        overview: { label: "Overview", icon: <FaTable /> },
        charts: { label: "Divisional Charts", icon: <FaChartBar /> },
        yoga: { label: "Yoga Analysis", icon: <FaStar /> },
        dasa: { label: "Dasa Analysis", icon: <FaHourglassHalf /> },
    };
            ...
            <div className="mx-auto max-w-7xl px-0 py-0 md:py-2">
                ...
                <div
                    ...
                    style={{
                        ...
                        boxShadow: "0 4px 20px rgba(125,27,46,0.15)",
                    }}>
                    <div
                        className="px-4 py-4"
                        style={{
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="mt-0.5 text-xs text-white/75">
                                    {fmtDate(kundliData.datetime)} •{" "}
                                    {fmtTime(kundliData.datetime)} •{" "}
                    ...
                    <div
                        ...
                        <div className="px-3 py-2">
                            ...
                            <p
                                ...
                                {kundliData.panchanga.vara.name.hindi}
                            </p>
                        </div>
                        <div className="px-3 py-2">
                            <p
                        ...
                        <div className="px-3 py-2">
                            ...
                            <p
                                className="text-sm font-bold"
                                style={{ color: "var(--c-text)" }}>
                                {kundliData.panchanga.sunrise.dt.toFormat(
                                    "hh:mm a"
                                )}
                            </p>
                        </div>
                        ...
                        <section
                            ...
                            <div
                                ...
                                <KundliChartSVG
                                    ...
                                    chartSetting={{ width: 300, height: 300 }}
                                />
                            </div>
                        </section>
                    ...
                    <div className="space-y-4">
                        <section
                            ...
                            <h2
                                ...
                                style={{ color: "var(--c-maroon)" }}>
                                विभागीय चार्ट — Divisional Charts
                            </h2>
                            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                                {charts.map(chart => (
                                    <article
                                        ...
                                        <div
                                            className="flex justify-center overflow-x-auto rounded-lg p-2"
                                            style={{
                                                background: "var(--c-surface)",
                                                border: "1px solid var(--c-border)",
                                            }}>
