import { PakshaDetails, type PakshaName } from "src/backend/services/constants/Paksha";
import type { CalculatedDetail, Translation } from "src/backend/services/types";
