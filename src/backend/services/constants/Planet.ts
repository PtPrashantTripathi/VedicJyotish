import {
    ...
    type HouseDetail,
    type HouseNumber,
} from "src/backend/services/constants/Houses";
import { getNakshatra, type Nakshatra } from "src/backend/services/constants/Nakshatra";
import {
    getRasi,
    type Rasi,
    type RasiEn,
    type RasiNumber,
} from "src/backend/services/constants/Rasi";
import type { DayEn } from "src/backend/services/constants/Varas";
import type { Translation } from "src/backend/services/types";
import { MOD360, NORMALIZE12 } from "src/backend/services/utils";
