 ...
 */
import { toFixedLengthArray } from "src/backend/modules/fixed-len-array";
import type { DateTime } from "luxon";
import { calculateKalavelas } from "src/backend/services/calcKalavelas";
import { calcSamvatsara } from "src/backend/services/calcPanchanga/calc_samvatsara";
import { find_lunar_event_time } from "src/backend/services/calcPanchanga/find_lunar_event_time";
import { find_yoga_crossing_time } from "src/backend/services/calcPanchanga/find_yoga_crossing_time";
import { calculateRahuKalam } from "src/backend/services/calcRahuKalam";
import { calcRiseSet } from "src/backend/services/calcRiseSet";
import { getKarana } from "src/backend/services/constants/Karana";
import {
    getMaaha,
    type MaahaNumber,
} from "src/backend/services/constants/Maaha";
import { getNakshatra } from "src/backend/services/constants/Nakshatra";
import { getRasi } from "src/backend/services/constants/Rasi";
import { getTithi } from "src/backend/services/constants/Tithi";
import { type DayEn, VarasDetails } from "src/backend/services/constants/Varas";
import { getYoga } from "src/backend/services/constants/Yoga";
import { MOD360 } from "src/backend/services/utils";
