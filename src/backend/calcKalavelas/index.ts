import { calculateDayKalavelas } from "src/backend/calcKalavelas/dayKalavelas";
import { calculateNightKalavelas } from "src/backend/calcKalavelas/nightKalavelas";
import { decimalToHMS } from "src/backend/utils";
