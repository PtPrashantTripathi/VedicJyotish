import {
    ...
    type HouseDetail,
    type HouseNumber,
} from "src/backend/constants/Houses";
import { getNakshatra, type Nakshatra } from "src/backend/constants/Nakshatra";
import {
    getRasi,
    type Rasi,
    type RasiEn,
    type RasiNumber,
} from "src/backend/constants/Rasi";
import type { DayEn } from "src/backend/constants/Varas";
