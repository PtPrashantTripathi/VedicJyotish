import { type FixedLengthArray, toFixedLengthArray } from "src/backend/modules/fixed-len-array";
...
import type { SwissephModule } from "./wasm/swisseph";
import {
    ArrayPointer,
    NullPointer,
    NumberPointer,
    StringPointer,
    TypeConverter,
} from "src/backend/modules/wasp-lib";
