                            ...
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        <td>datetime</td>
                                        <td>
                                            {kundliData.panchanga.datetime.toISO()}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>weekday</td>
                                        <td>
                                            {
                                                kundliData.panchanga.vara.name
                                                    .hindi
                                            }
                                        </td>
                                    </tr>
                        ...
                        <section>
                            ...
                            <KundliChartSVG
                                chartData={Object.values(
                                    ...
                                    rasi_num:
                                        planet.divisional.shashtamsa.rasi_num,
                                }))}
                            />
                            ...
                            <KundliChartSVG
                                chartData={Object.values(
                                    ...
                                    rasi_num:
                                        planet.divisional.ashtamsa.rasi_num,
                                }))}
                            />
                            <h3>Navamsa chart</h3>
                            <KundliChartSVG
                                chartData={Object.values(
                                    ...
                                    rasi_num:
                                        planet.divisional.navamsa.rasi_num,
                                }))}
                            />
                        </section>
